...
export const quickOptions: TimeOption[] = [
  ...
  { from: 'now-1h', to: 'now', display: 'Последний 1 час', section: 3 },
  ...
  { from: 'now-1y', to: 'now', display: 'Последний 1 год', section: 3 },
...
export const otherOptions: TimeOption[] = [
  ...
  { from: 'now/w', to: 'now', display: 'Эта неделя до текущего времени', section: 3 },
